...
// 					        	var libro = {titulo:data[0].titulo,descripcion:descripcion,categoria :categoria,ruta_portada:data[0].ruta_portada,id_ejemplar:data[0].id_ejemplar};
...
// 	});
// 	usuario.on('disconnect', function(socket) {
